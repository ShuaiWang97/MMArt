...
# job_id=$1
# python scripts/inference_eval.py --model_name Qwen/Qwen2.5-VL-72B-Instruct --job_id $job_id --data_source ../data/wikiart/wikiart_balanced_200.csv


python scripts/inference_eval.py --model_name Qwen/Qwen2.5-VL-72B-Instruct --job_id 0 --data_source ../wikiart_balanced_200.csv
